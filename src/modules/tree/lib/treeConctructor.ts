...
class Tree {
  ...
  public getSelectedNodes(selectedFlag?: boolean) {
    ...
    if (selectedFlag === true) {
      ...
      throw new TypeError(`Function getSelectedNodes accepts param type boolean only ~`)
    }
  }
  /**
  ...
  public getCheckedNodes(checkedFlag?: boolean) {
    ...
    if (checkedFlag === true) {
      ...
      throw new TypeError(`Function getCheckedNodes accepts param type boolean only ~`)
    }
  }
  ...
  public checkedAll(checkedFlag?: boolean) {
    ...
    if (checkedFlag === true) {
      ...
      throw new TypeError(`Function checkedAll accepts param type boolean only ~`)
    }
  }
  /**
   ...
   */
  public rebuildTree = (visibleData: ITreeNodeParams[]) => {
    const map: any = {}
    const tree: any = []
    visibleData.forEach((el: any) => {
      if (el.children) {
        delete el.children
      }
      map[el.id] = el
